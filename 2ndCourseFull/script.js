...
// Случайный цвет
const button = document.getElementById('genColorGame');
const miniGameCard = document.querySelector('.mini-game__card-js');

const originalColor = miniGameCard.style.backgroundColor || '#fff';
...
button.addEventListener('click', function() {
    if (!isColorChanged) {
        ...
        miniGameCard.style.backgroundColor = randomColor;
        isColorChanged = true;
    } else {
        miniGameCard.style.backgroundColor = originalColor;
